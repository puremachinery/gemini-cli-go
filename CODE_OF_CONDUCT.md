...
reported to the maintainers via GitHub issues or direct contact listed in
...
2. **Warning**: A warning with consequences for continued behavior, including
   a defined period during which the person may not interact with the community.
3. **Temporary Ban**: A temporary ban from any sort of interaction or public
   communication with the community for a defined period.
